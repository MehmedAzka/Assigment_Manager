...
<body id="body-pd">
    ...
    <div class="height-100 bg-light">
        <div class="container pt-4">
            ...
            <a href="article.php" type="button" class="btn btn-outline-primary rounded-pill mb-2 active">Article</a>
            <!-- Output Event -->
            <?php if (mysqli_num_rows($sql) > 0) {
                ...
                <div class="position-absolute top-50 start-50 translate-middle">
                    <p class="fs-1 text-center text-secondary">No Article</p>
                </div>
            <?php } ?>
        </div>
        <br>
